...
@Component({
    selector: 'app-new-servicedesk-report',
    templateUrl: './new-servicedesk-report.component.html',
    styleUrls: ['./new-servicedesk-report.component.scss']
})
export class NewServicedeskReportComponent {
    units: any[];
    selectedUnit?: any;
    stateReport: any;
    statesReport: any;
